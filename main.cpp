...
int main()
{
    ...
    Vector vvv(vec.begin(), vec.end());

    float sd = 87, ds = 56665;

    Fraction ffr(23,45);
    Fraction ffrr = 10;

//    cout << typeid(vec).name() << endl;
//    cout << ffr.to_double() << endl;
//    cout << typeid(sd).name();
    ...
    Matrix a = {{}, {0, -5, 10, -3, 3}, {}, {4, 5, -9, 9, -7}, {-5, 10, 0, -4, 4}};
    Matrix sac = {{5, 5, -6, 1, 0}, {3, 4, 5, 7, 8}, {1, 11, 6, 1, 7}, {4, 5, -9, 9, -7}, {5, 10, 0, -4, 4}};
    ...
    Matrix f = { {4, 0, 8, 6}, {1, 0, 7, 7}, {8, 0, 8, 8}, {-1, -4, -5, 0} };
